...
import { alfombras } from "../utils/images";
    ...
    <Container fluid>
      <Row className="mt-5 justify-content-center align-items-center">
        <Col xs={11} className="mt-5">
          <p className="h1 promasa-color my-5">ALFOMBRAS</p>
        </Col>
      </Row>
        ...
        return (
          <Row className="my-3 justify-content-center align-items-center">
            <Col xs={11} className="text-center">
              <p className="h2 promasa-color my-3">{alf.title}</p>
            </Col>
            <Col xs={11}>
                    ...
                    <Col xs={5} md={4} lg={2} className="m-3">
                      <Fade top delay={delay}>
                        <div
                          ...
                          onClick={() => handleShow(img, alf.title)}
                        >
                          <Image
                            rounded
                            src={img}
